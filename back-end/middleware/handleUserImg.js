...
var storage = multer.diskStorage({
  ...
  destination: function (req, file, cb) {
    cb(null, PATH.resolve(__dirname, '../public/portrait'))
  },
  // 文件名字
  filename: function (req, file, cb) {
    ...
    req.body.portrait = '/portrait/' + _filename  //注意路径 从showPoster里取的
    cb(null, _filename)
  }
})
...
// 已经是一个中间件了
var upload = multer({ storage, fileFilter }).single('portrait') // .single处理单文件上传
